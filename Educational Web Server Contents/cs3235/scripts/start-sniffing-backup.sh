...
# Start tshark
sudo tshark -i enp0s3 -w $FILE -f "host $HOST_IP and port 80 and tcp[((tcp[12:1] & 0xf0) >> 2):4] = 0x504F5354" > /dev/null 2>&1 &
#sudo tshark -w $FILE -f "host 204.15.135.8 and port 80 and tcp[((tcp[12:1] & 0xf0) >> 2):4] = 0x504F5354" > /dev/null 2>&1 &
